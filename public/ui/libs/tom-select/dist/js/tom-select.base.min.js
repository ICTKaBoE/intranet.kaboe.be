...
!function (e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).TomSelect = t(); }(this, (function () {
    ...
    }, h = (e, t) => { if (e) return e[t]; }, g = (e, t) => { if (e) { for (var i, s = t.split("."); (i = s.shift()) && (e = e[i]);); return e; } }, v = (e, t, i) => {
        var s, n;
        return e ? -1 === (n = (e += "").search(t.regex)) ? 0 : (s = t.string.length / e.length, 0 === n && (s += .5), s * i) : 0;
    }, f = e => (e + "").replace(/([\$\(-\+\.\?\[-\^\{-\}])/g, "\\$1"), m = (e, t) => {
        var i = e[t];
    ...
    class w {
        constructor(e, t) { this.items = e, this.settings = t || { diacritics: !0 }; } tokenize(e, t, i) {
            ...
            const s = [], n = e.split(/\s+/);
            var o;
            return i && (o = new RegExp("^(" + Object.keys(i).map(f).join("|") + "):(.*)$")), n.forEach((e => {
                let i, n = null, r = null;
                o && (i = e.match(o)) && (n = i[1], e = i[2]), e.length > 0 && (r = f(e), this.settings.diacritics && (r = u(r)), t && (r = "\\b" + r)), s.push({ string: e, regex: r ? new RegExp(r, "iu") : null, field: n });
            })), s;
            ...
            const l = 1 === o ? function (e, t) {
                const i = s[0].field;
                return v(r(t, i), e, n[i]);
            } : function (e, t) {
                var i = 0;
                if (e.field) {
                    const s = r(t, e.field);
                    !e.regex && s ? i += 1 / o : i += v(s, e, 1);
                } else y(n, ((s, n) => { i += v(r(t, n), e, s); }));
                return i / o;
            };
    ...
    }, I = e => "string" == typeof e && e.indexOf("<") > -1, _ = (e, t) => {
        var i = document.createEvent("HTMLEvents");
        i.initEvent(t, !0, !1), e.dispatchEvent(i);
    }, S = (e, t) => { Object.assign(e.style, t); }, A = (e, ...t) => { var i = F(t); (e = x(e)).map((e => { i.map((t => { e.classList.add(t); })); })); }, C = (e, ...t) => { var i = F(t); (e = x(e)).map((e => { i.map((t => { e.classList.remove(t); })); })); }, F = e => {
        var t = [];
    ...
    }, L = (e, t = 0) => t > 0 ? e[e.length - 1] : e[0], P = (e, t) => {
        if (!e) return -1;
        t = t || e.nodeName;
        for (var i = 0; e = e.previousElementSibling;)e.matches(t) && i++;
        return i;
    }, E = (e, t) => { y(t, ((t, i) => { null == t ? e.removeAttribute(i) : e.setAttribute(i, "" + t); })); }, T = (e, t) => { e.parentNode && e.parentNode.replaceChild(t, e); }, V = (e, t) => {
        if (null === t) return;
        if ("string" == typeof t) {
            if (!t.length) return;
            t = new RegExp(t, "i");
            ...
            if (i && e.data.length > 0) {
                ...
                var o = n.cloneNode(!0);
                return s.appendChild(o), T(n, s), 1;
            } return 0;
        ...
        i(e);
    }, $ = "undefined" != typeof navigator && /Mac/.test(navigator.userAgent) ? "metaKey" : "ctrlKey";
    ...
    const q = e => null == e ? null : D(e), D = e => "boolean" == typeof e ? e ? "1" : "0" : e + "", N = e => (e + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;"), R = (e, t) => {
        var i;
        return function (s, n) {
            var o = this;
    ...
    }, z = (e, t = !1) => { e && (e.preventDefault(), t && e.stopPropagation()); }, K = (e, t, i, s) => { e.addEventListener(t, i, s); }, M = (e, t) => !!t && (!!t[e] && 1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0)), B = (e, t) => {
    ...
    function J(e, t) {
        ...
        if (!p && !i.allowEmptyOption) {
            ...
            t && (p = t.textContent);
        } var u, h, g, v, f, m, O = { placeholder: p, options: [], optgroups: [], items: [], maxItems: null };
        return "select" === d ? (h = O.options, g = {}, v = 1, f = e => {
            ...
            var t, i, s;
            "optgroup" === (u = e.tagName.toLowerCase()) ? ((s = f(t = e))[a] = s[a] || t.getAttribute("label") || "", s[c] = s[c] || v++, s[r] = s[r] || t.disabled, O.optgroups.push(s), i = s[c], y(t.children, (e => { m(e, i); }))) : "option" === u && m(e);
        }))) : (() => {
    ...
    class W extends (function (e) {
        return e.plugins = {}, class extends e {
            ...
            constructor(e, t) {
                ...
                var u;
                if (A(r, n.wrapperClass, d, p), A(l, n.controlClass), G(r, l), A(a, n.dropdownClass, p), n.copyClassesToDropdown && A(a, d), A(c, n.dropdownContentClass), G(a, c), b(n.dropdownParent || r).appendChild(a), I(n.controlInput)) {
                    u = b(n.controlInput);
                    y(["autocorrect", "autocapitalize", "autocomplete"], (e => { s.getAttribute(e) && E(u, { [e]: s.getAttribute(e) }); })), u.tabIndex = -1, l.appendChild(u), this.focus_node = u;
                } else n.controlInput ? (u = b(n.controlInput), this.focus_node = u) : (u = b("<input/>"), this.focus_node = l);
                ...
                if (h) {
                    K(h, "click", g), E(h, { for: p });
                    const t = B(h, e.inputId + "-ts-label");
                    E(a, { "aria-labelledby": t }), E(n, { "aria-labelledby": t });
                } if (o.style.width = l.style.width, e.plugins.names.length) {
                    const t = "plugin-" + e.plugins.names.join(" plugin-");
                    A([o, s], t);
                } (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && E(l, { multiple: "multiple" }), e.settings.placeholder && E(i, { placeholder: t.placeholder }), !e.settings.splitOn && e.settings.delimiter && (e.settings.splitOn = new RegExp("\\s*" + f(e.settings.delimiter) + "+\\s*")), t.load && t.loadThrottle && (t.load = R(t.load, t.loadThrottle)), e.control_input.type = l.type, K(s, "click", (t => {
                    const i = k(t.target, "[data-selectable]");
                    i && (e.onOptionSelect(t, i), z(t, !0));
                })), K(r, "click", (t => {
                    var s = k(t.target, "[data-ts-item]", r);
                    s && e.onItemSelect(t, s) ? z(t, !0) : "" == i.value && (e.onClick(), z(t, !0));
                })), K(a, "keydown", (t => e.onKeyDown(t))), K(i, "keypress", (t => e.onKeyPress(t))), K(i, "input", (t => e.onInput(t))), K(a, "resize", (() => e.positionDropdown()), c), K(a, "blur", (t => e.onBlur(t))), K(a, "focus", (t => e.onFocus(t))), K(a, "paste", (t => e.onPaste(t)));
                const v = t => {
                ...
                const t = this, i = e ? J(t.input, { delimiter: t.settings.delimiter }) : t.settings;
                ...
                var t = this;
                t.isInputHidden || t.isLocked ? z(e) : t.settings.splitOn && setTimeout((() => {
                    var e = t.inputValue();
                ...
                if (!t.isLocked) {
                    ...
                    return t.settings.create && "multi" === t.settings.mode && i === t.settings.delimiter ? (t.createItem(), void z(e)) : void 0;
                } z(e);
            } onKeyDown(e) {
                var t = this;
                if (t.isLocked) 9 !== e.keyCode && z(e);
                    ...
                    switch (e.keyCode) {
                        case 65: if (M($, e) && "" == t.control_input.value) return z(e), void t.selectAll();
                            break;
                ...
                var i, s = this;
                t.parentElement && t.parentElement.matches("[data-disabled]") || (t.classList.contains("create") ? s.createItem(null, !0, (() => { s.settings.closeAfterSelect && s.close(); })) : void 0 !== (i = t.dataset.value) && (s.lastQuery = null, s.addItem(i), s.settings.closeAfterSelect && s.close(), !s.settings.hideSelected && e.type && /click/.test(e.type) && s.setActiveOption(t)));
            } canSelect(e) { return !!(this.isOpen && e && this.dropdown_content.contains(e)); } onItemSelect(e, t) {
                var i = this;
                return !i.isLocked && "multi" === i.settings.mode && (z(e), i.setActiveItem(t, e), !0);
                ...
                const i = this;
                i.loading = Math.max(i.loading - 1, 0), i.lastQuery = null, i.clearActiveOption(), i.setupOptions(e, t), i.refreshOptions(i.isFocused && !i.isInputHidden), i.loading || C(i.wrapper, i.settings.loadingClass), i.trigger("load", e, t);
            } preload() {
            ...
            } getValue() { return this.is_select_tag && this.input.hasAttribute("multiple") ? this.items : this.items.join(this.settings.delimiter); } setValue(e, t) { H(this, t ? [] : ["change"], (() => { this.clear(t), this.addItems(e, t); })); } setMaxItems(e) { 0 === e && (e = null), this.settings.maxItems = e, this.refreshState(); } setActiveItem(e, t) {
                var i, s, n, o, r, l, a = this;
                if ("single" !== a.settings.mode) {
                    if (!e) return a.clearActiveItems(), void (a.isFocused && a.showInput());
                    if ("click" === (i = t && t.type.toLowerCase()) && M("shiftKey", t) && a.activeItems.length) {
                        ...
                        z(t);
                    } else "click" === i && M($, t) || "keydown" === i && M("shiftKey", t) ? e.classList.contains("active") ? a.removeActiveItem(e) : a.setActiveItemClass(e) : (a.clearActiveItems(), a.setActiveItemClass(e));
                    a.hideInput(), a.isFocused || a.focus();
                }
            } setActiveItemClass(e) {
                const t = this, i = t.control.querySelector(".last-active");
                i && C(i, "last-active"), A(e, "active last-active"), t.trigger("item_select", e), -1 == t.activeItems.indexOf(e) && t.activeItems.push(e);
            } removeActiveItem(e) {
                var t = this.activeItems.indexOf(e);
                this.activeItems.splice(t, 1), C(e, "active");
            } clearActiveItems() { C(this.activeItems, "active"), this.activeItems = []; } setActiveOption(e) { e !== this.activeOption && (this.clearActiveOption(), e && (this.activeOption = e, E(this.focus_node, { "aria-activedescendant": e.getAttribute("id") }), E(e, { "aria-selected": "true" }), A(e, "active"), this.scrollToOption(e))); } scrollToOption(e, t) {
                if (!e) return;
            ...
            } clearActiveOption() { this.activeOption && (C(this.activeOption, "active"), E(this.activeOption, { "aria-selected": null })), this.activeOption = null, E(this.focus_node, { "aria-activedescendant": null }); } selectAll() {
                if ("single" === this.settings.mode) return;
                const e = this.controlChildren();
                e.length && (this.hideInput(), this.close(), this.activeItems = e, A(e, "active"));
            } inputState() {
                var e = this;
                e.control.contains(e.control_input) && (E(e.control_input, { placeholder: e.settings.placeholder }), e.activeItems.length > 0 || !e.isFocused && e.settings.hidePlaceholder && e.items.length > 0 ? (e.setTextboxValue(), e.isInputHidden = !0) : (e.settings.hidePlaceholder && e.items.length > 0 && E(e.control_input, { placeholder: "" }), e.isInputHidden = !1), e.wrapper.classList.toggle("input-hidden", e.isInputHidden));
                ...
                for (O && (c = O.dataset.value, d = O.closest("[data-group]")), n = m.items.length, "number" == typeof v.settings.maxOptions && (n = Math.min(n, v.settings.maxOptions)), n > 0 && (w = !0), t = 0; t < n; t++) {
                    let e = m.items[t].id, n = v.options[e], l = v.getOption(e, !0);
                    ...
                    if (v.optgroups.hasOwnProperty(e) && u[e].children.length) {
                        let t = document.createDocumentFragment(), i = v.render("optgroup_header", v.optgroups[e]);
                        G(t, i), G(t, u[e]);
                        let s = v.render("optgroup", { group: v.optgroups[e], options: t });
                        G(l, s);
                    } else G(l, u[e]);
                })), b.innerHTML = "", G(b, l), v.settings.highlight && (g = b.querySelectorAll("span.highlight"), Array.prototype.forEach.call(g, (function (e) {
                    var t = e.parentNode;
                    t.replaceChild(e.firstChild, e), t.normalize();
                })), m.query.length && m.tokens.length && y(m.tokens, (e => { V(b, e.regex); })));
                var I = e => {
                    let t = v.render(e, { input: f });
                    return t && (w = !0, b.insertBefore(t, b.firstChild)), t;
                };
                if (v.loading ? I("loading") : v.settings.shouldLoad.call(v, f) ? 0 === m.items.length && I("no_results") : I("not_loading"), (a = v.canCreate(f)) && (p = I("option_create")), v.hasOptions = m.items.length > 0 || a, w) {
                    if (m.items.length > 0) {
                        if (!b.contains(O) && "single" === v.settings.mode && v.items.length && (O = v.getOption(v.items[0])), !b.contains(O)) {
                            let e = 0;
                ...
                if (t.$order = t.$order || i.options[o].$order, delete i.options[o], i.uncacheValue(r), i.options[r] = t, l) {
                    if (i.dropdown_content.contains(l)) {
                        ...
                        T(l, e), i.activeOption === l && i.setActiveOption(e);
                    } l.remove();
                } a && (-1 !== (n = i.items.indexOf(o)) && i.items.splice(n, 1, r), s = i._render("item", t), a.classList.contains("active") && A(s, "active"), T(a, s)), i.lastQuery = null;
            } removeOption(e, t) {
                const i = this;
                ...
                H(this, t ? [] : ["change", "dropdown_close"], (() => {
                    var i, s;
                ...
                var e = this;
                e.isLocked || e.isOpen || "multi" === e.settings.mode && e.isFull() || (e.isOpen = !0, E(e.focus_node, { "aria-expanded": "true" }), e.refreshState(), S(e.dropdown, { visibility: "hidden", display: "block" }), e.positionDropdown(), S(e.dropdown, { visibility: "visible", display: "block" }), e.focus(), e.trigger("dropdown_open", e.dropdown));
            } close(e = !0) {
                var t = this, i = t.isOpen;
                e && (t.setTextboxValue(), "single" === t.settings.mode && t.items.length && t.hideInput()), t.isOpen = !1, E(t.focus_node, { "aria-expanded": "false" }), S(t.dropdown, { display: "none" }), t.settings.hideSelected && t.clearActiveOption(), t.refreshState(), i && t.trigger("dropdown_close", t.dropdown);
            } positionDropdown() {
                if ("body" === this.settings.dropdownParent) {
                    ...
                    S(this.dropdown, { width: t.width + "px", top: i + "px", left: s + "px" });
                }
            } clear(e) {
                var t = this;
                if (t.items.length) {
                ...
                var i, s, n = this;
                n.rtl && (e *= -1), n.inputValue().length || (M($, t) || M("shiftKey", t) ? (s = (i = n.getLastActive(e)) ? i.classList.contains("active") ? n.getAdjacent(i, e, "item") : i : e > 0 ? n.control_input.nextElementSibling : n.control_input.previousElementSibling) && (s.classList.contains("active") && n.removeActiveItem(i), n.setActiveItemClass(s)) : n.moveCaret(e));
            } moveCaret(e) { } getLastActive(e) {
                let t = this.control.querySelector(".last-active");
                if (t) return t;
                var i = this.control.querySelectorAll(".active");
                return i ? L(i, e) : void 0;
                ...
                e.trigger("destroy"), e.off(), e.wrapper.remove(), e.dropdown.remove(), e.input.innerHTML = t.innerHTML, e.input.tabIndex = t.tabIndex, C(e.input, "tomselected", "ts-hidden-accessible"), e._destroy(), delete e.input.tomselect;
