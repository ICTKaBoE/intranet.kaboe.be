...
{
    public function __construct($endpoint, $schoolyear, $object, $idField = 'id', $orderField = 'id', $orderDirection = 'ASC')
    {
    ...
    private function performGet()
    {
        ...
        $host = rtrim($settingsRepo->get("informat.get")[0]->value, "/");
        $username = trim($settingsRepo->get("informat.soap.username")[0]->value);
        $password = trim($settingsRepo->get("informat.soap.password")[0]->value);
