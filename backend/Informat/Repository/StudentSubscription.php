...
class StudentSubscription extends Repository
{
	...
	{
		parent::__construct("Inschrijvingen", INFORMAT_CURRENT_SCHOOLYEAR, "110064", \Informat\Object\StudentSubscription::class, idField: 'PInschrijvingen', orderField: 'Begindatum');
