    ...
    <div class="card-body">
        <div class="row mb-3">
            <div class="col">
                ...
                <select name="schoolId" id="schoolId" data-load-source="{{select:url:short}}/school" data-default-value="{{url:param.schoolId}}" required></select>
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <select name="name" id="name" data-load-source="{{select:url:short}}/{{url:part.module}}/person/extranet" data-value="name" data-extra="[schoolId={{url:param.schoolId}}]" data-parent-select="schoolId" required></select>
