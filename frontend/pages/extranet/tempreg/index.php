                ...
                <div class="card-body" id="tbl{{page:id}}">
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <select name="schoolId" id="schoolId" data-load-source="{{select:url:short}}/school" data-load-value="id" data-load-label="name" data-optgroup-attribute="optgroup" data-optgroup-value="id" data-optgroup-label="name" data-default-value="{{url:param.schoolId}}" required></select>
