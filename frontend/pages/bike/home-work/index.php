...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card mb-3">
            ...
            <div class="card-body" role="legenda" id="leg{{page:id}}" data-source="{{legenda:url:short}}/{{url:part.module}}/distance" data-template="<?= LEGENDA_TEMPLATE; ?>" data-extra="[type=HW]"></div>
            <div class="card-body">
