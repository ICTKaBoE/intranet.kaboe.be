            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select name="departmentId" id="departmentId" data-load-source="{{select:url:short}}/school/department" data-parent-select="schoolId" data-default-no-load data-disable-if-no-options required></select>
                    </div>
                </div>
            </div>
