            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select name="departmentId" id="departmentId" data-load-source="{{select:url:short}}/school/department" data-parent-select="schoolId" data-default-no-load data-disable-if-no-options></select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select name="typeId" id="typeId" data-load-source="{{select:url:short}}/{{url:part.module}}/type" data-parent-select="departmentId" data-default-no-load data-disable-if-no-options></select>
                    </div>
                </div>
            </div>
