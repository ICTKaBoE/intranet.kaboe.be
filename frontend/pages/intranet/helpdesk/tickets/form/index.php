        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="mb-2">
                    ...
                    <select name="assetId" id="assetId" data-load-source="[L@{{select:url:short}}/management/laptop;D@{{select:url:short}}/management/desktop;I@{{select:url:short}}/management/ipad;B@{{select:url:short}}/management/beamer;P@{{select:url:short}}/management/printer;F@{{select:url:short}}/management/firewall;S@{{select:url:short}}/management/switch;A@{{select:url:short}}/management/accesspoint]" data-label="[L@name;D@name;I@name;B@serialnumber;P@name;F@hostname;S@name;A@name]" data-default-no-load data-disable-if-no-options></select>
                ...
                <div class="mb-2">
                    ...
                    <select name="assignedToUserId" id="assignedToUserId" data-load-source="{{select:url:short}}/user" data-label="formatted.fullNameReversed" data-extra="[id={{module:assignableUsers}}]" data-search></select>
