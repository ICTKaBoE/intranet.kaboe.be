        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-4 mb-3">
                    ...
                    <select name="schoolId" id="schoolId" data-load-source="{{select:url:short}}/school" data-on-change="deviceView" data-default-value="{{user:mainSchoolId}}" required></select>
                </div>
                ...
                <div class="col-lg-4 mb-3">
                    ...
                    <select name="roomId" id="roomId" data-load-source="{{select:url:short}}/management/room" data-label="formatted.full" data-parent-select="schoolId" data-on-change="deviceView" data-extra="[schoolId={{user:mainSchoolId}}]" data-search data-disable-if-no-options></select>
                </div>

                <div class="col-lg-8 mb-3">
                    <label class="form-label" for="assetId">Toestel</label>
                    <select name="assetId" id="assetId" data-load-source="[L@{{select:url:short}}/management/laptop;D@{{select:url:short}}/management/desktop;I@{{select:url:short}}/management/ipad;B@{{select:url:short}}/management/beamer;P@{{select:url:short}}/management/printer;F@{{select:url:short}}/management/firewall;S@{{select:url:short}}/management/switch;A@{{select:url:short}}/management/accesspoint]" data-label="[L@name;D@name;I@name;B@serialnumber;P@name;F@hostname;S@name;A@name]" data-default-no-load data-disable-if-no-options data-search></select>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        ...
                        <select name="status" id="status" data-load-source="{{select:url:short}}/{{url:part.module}}/status"></select>

                    </div>

                    <div class="mb-2">
                        <label class="form-label mb-1" for="category">Categorie</label>
                        <select name="category" id="category" data-load-source="{{select:url:short}}/{{url:part.module}}/category" data-on-change="deviceView" data-render-item="renderOptgroupItem"></select>
                    ...
                    <div class="mb-2">
                        ...
                        <select name="roomId" id="roomId" data-load-source="{{select:url:short}}/management/room" data-label="formatted.full" data-parent-select="schoolId" data-search data-default-no-load data-disable-if-no-options></select>

                    </div>

                    <div class="mb-2">
                        <label class="form-label mb-1" for="assetId">Toestel</label>
                        <select name="assetId" id="assetId" data-load-source="[L@{{select:url:short}}/management/laptop;D@{{select:url:short}}/management/desktop;I@{{select:url:short}}/management/ipad;B@{{select:url:short}}/management/beamer;P@{{select:url:short}}/management/printer;F@{{select:url:short}}/management/firewall;S@{{select:url:short}}/management/switch;A@{{select:url:short}}/management/accesspoint]" data-label="[L@name;D@name;I@name;B@serialnumber;P@name;F@hostname;S@name;A@name]" data-default-no-load data-search data-disable-if-no-options></select>
                    ...
                    <div class="mb-2">
                        ...
                        <select name="assignedToUserId" id="assignedToUserId" data-load-source="{{select:url:short}}/user" data-label="formatted.fullNameReversed" data-search></select>
