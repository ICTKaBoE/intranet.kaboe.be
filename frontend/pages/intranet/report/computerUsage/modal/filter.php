    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="schoolyear" class="form-label">Schooljaar</label>
                        <input type="text" name="schoolyear" id="schoolyear" value="{{schoolyear}}" class="form-control" data-mask="0000-00" />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select name="type" id="type">
                            <option value="%LLN%">Leerlingenlaptop</option>
                            <option value="%PER%">Personeelslaptop</option>
                            <option value="%PC%">Vaste computer</option>
                        </select>
                    </div>
                </div>
            </div>
