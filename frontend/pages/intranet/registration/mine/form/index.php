<form action="{{form:url:full}}" class="card col-12" method="post" id="frm{{page:id}}">
        ...
        <fieldset class="form-fieldset">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-12 mb-3">
                    ...
                    <input type="text" name="callName" id="callName" class="form-control" value="{{url:param.callName}}" />
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-12 mb-3">
                    ...
                    <input type="text" role="datepicker" name="birthDate" id="birthDate" class="form-control" value="{{url:param.birthDate}}" required />
                </div>

                <div class="col-lg-3 col-12 mb-3">
                    <label class="form-label" for="birthPlace">Geboorteplaats</label>
                    <input type="text" name="birthPlace" id="birthPlace" class="form-control" value="{{url:param.birthPlace}}" required />
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-12 mb-3">
                    ...
                    <input type="text" name="insz" id="insz" class="form-control" data-mask="00.00.00-000.00" value="{{url:param.insz}}" required />
                </div>
        ...
        <fieldset class="form-fieldset">
            ...
            <div class="row">
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="addressStreet" id="addressStreet" class="form-control" value="{{url:param.addressStreet}}" required />
                </div>

                <div class="col-lg-3 col-12 mb-3">
                    <label class="form-label" for="addressNumber">Huisnummer</label>
                    <input type="number" name="addressNumber" id="addressNumber" class="form-control" value="{{url:param.addressNumber}}" required />
                </div>

                <div class="col-lg-3 col-12 mb-3">
                    <label class="form-label" for="addressBus">Bus</label>
                    <input type="text" name="addressBus" id="addressBus" class="form-control" value="{{url:param.addressBus}}" />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-12 mb-3">
                    ...
                    <input type="text" name="addressZipcode" id="addressZipcode" class="form-control" value="{{url:param.addressZipcode}}" required />
                </div>

                <div class="col-lg-6 col-12 mb-3">
                    <label class="form-label" for="addressCity">Gemeente</label>
                    <input type="text" name="addressCity" id="addressCity" class="form-control" value="{{url:param.addressCity}}" required />
                </div>
