<div class="card col-12 col-lg-6 mx-auto">
    <form action="{{form:url:full}}" method="post" autocomplete="off" id="frm{{page:id}}" data-prefill-id="{{url:part.id}}">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12" id="chbWarnPasswordExpiration" role="checkbox" data-type="checkbox" data-name="warnPasswordExpiration" data-text="Waarschuwen via e-mail als het wachtwoord vervalt"></div>
                <div class="col-12" id="chbImport" role="checkbox" data-type="checkbox" data-name="import" data-text="Importeren uit Informat"></div>
                <div class="col-12" id="chbSync" role="checkbox" data-type="checkbox" data-name="sync" data-text="Synchroniseren" data-on-change="syncView"></div>
            </div>
