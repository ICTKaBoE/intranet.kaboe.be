    ...
    <form action="{{form:url:full}}" method="post" autocomplete="off" id="frm{{page:id}}" data-prefill-id="{{url:part.id}}">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mb-3">
                    <label for="departmentId" class="form-label">Afdeling</label>
                    <select name="departmentId" id="departmentId" data-load-source="{{select:url:short}}/school/department" data-parent-select="schoolId" data-default-no-load required></select>
                </div>
            </div>
