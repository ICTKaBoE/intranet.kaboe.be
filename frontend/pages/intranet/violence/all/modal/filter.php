            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <select name="schoolId" id="schoolId" data-load-source="{{select:url:short}}/school/all" data-load-value="id" data-load-label="name" data-default-value="{{user:mainSchoolId}}"></select>
                    </div>
                </div>
            </div>
