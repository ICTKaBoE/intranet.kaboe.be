			...
			<div class="modal-body" data-form-type="create|update">
				<div class="row mb-3 border-bottom">
					<div class="col-md-6 mb-lg-4">
						...
						<select name="schoolId" id="schoolId" data-load-source="{{select:url:short}}/school" data-load-value="id" data-load-label="name" data-on-change="check" disabled required></select>
					...
					<div class="col-md-6 mb-lg-4">
						...
						<select name="type" id="type" data-on-change="check" data-load-source="{{select:url:short}}/{{url:part:module}}/type" data-load-value="id" data-load-label="description" disabled required></select>
