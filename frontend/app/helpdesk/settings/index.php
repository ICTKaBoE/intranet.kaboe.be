			...
			<div class="card-body">
				...
				<div class="row mb-3">
					<div class="col">
						...
						<select class="form-control" name="assignToIds" id="assignToIds" data-load-source="{{select:action}}/users" data-load-value="id" data-load-label="fullName" data-multiple required></select>
				...
				<div class="row mb-3">
					<div class="col">
						...
						<select class="form-control" name="informNewToIds" id="informNewToIds" data-load-source="{{select:action}}/users" data-load-value="id" data-load-label="fullName" data-multiple required></select>
