        ...
        <form action="{{form:url:full}}" method="post">
            <div class="card">
                <div class="card-body" id="tbl{{page:id}}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="studentOrStaff" class="form-label">Kies student of personeelslid</label>
                        ...
                        <div class="col-md-6">
                            <label for="personId" class="form-label">Kies de ontlenende</label>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="bookId" id="bookId" data-load-source="{{select:url:short}}/{{url:part:module}}/availablebooks" data-load-value="id" data-load-label="lendTitle" data-parent-select="schoolId" multiple data-search required></select>
                        <div class="invalid-feedback" data-feedback-input="bookId"></div>
                    </div>

                    <div class="modal-footer" data-form-type="post-lend">
                        <button type="submit" class="btn btn-danger">Leen boek(en) uit</button>
                    </div>
                </div>
            </div>
        </form>
