<div class="row">
	...
	<div class="col-md-6 mb-3">
		<div class="card">
			<div class="card-body">
				<div id="cal{{page:id}}" role="calendar" data-source="[{{calendar:url:full}},{{calendar:url:short}}/holliday]" data-action="{{form:url:full}}" data-weekends data-date-click="setRide" data-range-start="{{homework:range:start}}" data-range-end="{{homework:range:end}}"></div>
			</div>
		</div>
	</div>
