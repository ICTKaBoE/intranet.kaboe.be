<div class="modal modal-blur fade" id="modal-management-beamer" tabindex="-1" style="display: none;" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<form action="{{form:url:full}}" method="post" id="frm{{page:id}}" class="modal-content" data-action-field="faction">
			<div class="modal-header">
				<h5 class="modal-title">Beamer</h5>
			...
			<div class="modal-body" data-form-type="delete">
				...
				<h1>Wenst u deze beamers te verwijderen?</h1>
			</div>
